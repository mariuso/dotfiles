return {
  ...
  opts = {
    bigfile = {
      ...
      -- Setup function that will be called when a big file is detected.
      -- Use this to disable features like LSP, treesitter, etc.
      -- Defaults to a function that will disable a bunch of plugins
      setup = function(ctx)
